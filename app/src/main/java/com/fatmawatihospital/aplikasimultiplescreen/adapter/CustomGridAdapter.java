...
public class CustomGridAdapter extends BaseAdapter {
    ...
    public CustomGridAdapter(GridViewActivity gridViewActivity, String[] dataNamaMakanan, int[] dataGambarMakanan) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater inflater = (LayoutInflater) gridViewActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
